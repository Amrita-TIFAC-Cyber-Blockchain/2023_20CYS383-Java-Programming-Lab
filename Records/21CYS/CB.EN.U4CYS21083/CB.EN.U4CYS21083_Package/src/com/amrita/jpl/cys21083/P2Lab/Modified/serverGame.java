...
public class serverGame extends quizGame {
    /**
     * QuizGameServer
     */
    ...
    public serverGame() {
        ...
        questions.add("What is Subject code for JPL");
        questions.add("which Semester are you in right now?");
        questions.add("What is the capital of India?");

        answers = new ArrayList<>();
        answers.add("20CYS383");
        answers.add("4");
        answers.add("Delhi");
    }
