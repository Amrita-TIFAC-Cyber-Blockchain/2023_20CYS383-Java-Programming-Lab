...
public class HashMapExample {
    ...
    public static void main(String[] args) {
        ...
        rollName_mark.put("CB.EN.U4CYS21011", 6.0);
        rollName_mark.put("CB.EN.U4CYS21021", 7.0);
        rollName_mark.put("CB.EN.U4CYS21031", 8.0);
        rollName_mark.put("CB.EN.U4CYS21041", 9.0);
        rollName_mark.put("CB.EN.U4CYS21051", 10.0);
        rollName_mark.put("CB.EN.U4CYS21061", 11.0);
        rollName_mark.put("CB.EN.U4CYS21071", 12.0);
        rollName_mark.put("CB.EN.U4CYS21081", 13.0);

        // Retrieve and print the name associated with a specific roll number
        System.out.println(rollName.get("CB.EN.U4CYS21051"));
    }
}
