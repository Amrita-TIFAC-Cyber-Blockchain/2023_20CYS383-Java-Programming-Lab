...
class Car1 extends Vehicle1 {
    ...
    Car1(String name, int yearr, int wheels_countt){
        model_name = name;
        year = yearr;
...
class Bike1 extends Vehicle1 {
    ...
    Bike1(String name, int yearr, int gears_countt){
        brand_name = name;
        year = yearr;
...
public class q2_vehicle{
    ...
    public static void main(String[] args){
        Car1 myCar = new Car1("Jaguar XF", 2022, 4);
        myCar.start();
        myCar.drive(3);
        myCar.stop();
        Bike1 myBike = new Bike1("Giant", 2021, 18);
        myBike.start();
        myBike.pedal(10);
        myBike.stop();
    }
