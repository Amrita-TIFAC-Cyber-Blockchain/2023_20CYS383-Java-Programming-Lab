...
public class AddressBook extends JFrame {
    ...
    /**
     * Constructs the AddressBook frame.
    ...
    private class AddButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (name.isEmpty() || phone.isEmpty() || email.isEmpty()) {
                JOptionPane.showMessageDialog(AddressBook.this, "Please fill in all the fields.",
                        "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (!isValidPhoneNumber(phone)) {
                JOptionPane.showMessageDialog(AddressBook.this, "Invalid phone number.",
                        "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (!isValidEmail(email)) {
                JOptionPane.showMessageDialog(AddressBook.this, "Invalid email address.",
                        "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private class DeleteButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int option = JOptionPane.showConfirmDialog(AddressBook.this,
     ...
     * Creates and displays the AddressBook frame.
     *
