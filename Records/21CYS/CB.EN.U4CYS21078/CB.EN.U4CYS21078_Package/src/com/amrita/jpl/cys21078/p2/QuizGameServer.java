...
public class QuizGameServer extends QuizGame {
    ...
    public QuizGameServer() {
        ...
        questions.add("Who invented java?");
        questions.add("Expand JRE");
        questions.add("Who was the first president of india?");

        answers = new ArrayList<>();
        answers.add("2");
        answers.add("James Gosling");
        answers.add("Java Runtime Environment");
        answers.add("Rajendra Prasad");
    }
