...
class ISphere implements IShape {

    /**
     * Calculates the TSA of the sphere.
     */
    public void area() {
        System.out.println("[Interface Method in Circle] This function is to calculate the total surface area of a sphere.\n");
        System.out.println("[Interface Method in Circle] TSA = 4 * PI * R^2");
    }

    /**
     * Displays information about the sphere.
     */
    public void display() {
