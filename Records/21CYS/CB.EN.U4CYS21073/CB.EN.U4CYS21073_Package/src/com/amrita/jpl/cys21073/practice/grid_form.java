...
public class grid_form extends JFrame {
    ...
    public grid_form() {
        ...
        // TextArea
        JTextArea tarea1 = new JTextArea("Sudeep V");
        JTextArea tarea2 = new JTextArea("sudeep@jpl.in");
        JTextArea tarea3 = new JTextArea("13-09-2003");
        JTextArea tarea4 = new JTextArea("9876543210");
