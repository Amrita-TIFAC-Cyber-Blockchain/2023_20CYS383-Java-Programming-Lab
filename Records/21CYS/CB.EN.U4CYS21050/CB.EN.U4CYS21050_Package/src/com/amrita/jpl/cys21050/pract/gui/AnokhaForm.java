package com.amrita.jpl.cys21050.pract.gui;
...
public class AnokhaForm extends JFrame {
    public AnokhaForm(){
        ...
        JTextArea tarea1 = new JTextArea("Nishanth");
        JTextArea tarea2 = new JTextArea("23232323");
        JTextArea tarea3 = new JTextArea("nish@gmail.com");
