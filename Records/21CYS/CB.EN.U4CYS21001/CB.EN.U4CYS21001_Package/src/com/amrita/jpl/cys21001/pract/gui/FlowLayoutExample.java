package com.amrita.jpl.cys21001.pract.gui;
...
public class FlowLayoutExample extends JFrame {
    ...
    public FlowLayoutExample() {
        ...
        // Buttons
        JButton button1 = new JButton("Abinesh G");
        JButton button2 = new JButton("CB.EN.U4CYS21001");
        JButton button3 = new JButton("11/10/03");
        JButton button4 = new JButton("Amrita Vishwa Vidyapeetham");
        JButton button5 = new JButton("6385919032");
        JButton button6 = new JButton("CSE - CYS");
        JButton button7 = new JButton("abineshiba080@gmail.com");
